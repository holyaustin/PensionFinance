...
//  const navigate = useNavigate();
  ...
  async function loadAssets() {
    /* create a generic provider and query for NFTMarketplace*/
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-5 pt-4">
          {nfts.map((nft, i) => (
            ...
            <div key={i} className="shadow rounded-xl overflow-hidden border-2 border-gray-500 bg-purple-200">
              ...
              />
              <div className="p-1">
                <p style={{ height: "34px" }} className="text-xl text-blue-700 font-semibold">Profile Name: {nft.name}</p>
                <div style={{ height: "75px", overflow: "hidden" }}>
                  <p className="text-gray-700">Quote: {nft.description}</p>
                </div>
              </div>
